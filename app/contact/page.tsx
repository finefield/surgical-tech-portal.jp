...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("https://formspree.io/f/mojrazgw", {
        method: "POST",
        body: data,
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
                  >
